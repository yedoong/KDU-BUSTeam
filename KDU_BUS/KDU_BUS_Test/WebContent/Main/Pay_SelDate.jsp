...
<body>
    ...
    <div id="wrapper">
        <header> <!-- s: header -->
        	<button class="material-icons-round" onclick="location.href = 'Pay_SelBus.jsp'">arrow_back_ios</button>
            <h1>경동대 셔틀버스</h1> 
     </header> <!-- e: header -->
            	...
            	<div class="popup-wrap">
        			<div class="popup"> 
        				...
        				<div class="popup-foot">
            				<button class="pop-btn close" id="close" onclick="location.href = 'Pay_SelDate.jsp'">닫기</button>
        				</div>
        			</div>
        		</div>
	<%
