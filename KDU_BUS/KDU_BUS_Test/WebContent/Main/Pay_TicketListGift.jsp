...
<body>
    ...
    <nav>
    	<div id="bus_1">
			...
			%>
					<div onclick="location.href='Pay_GiftTicket.jsp?date=<%=list.get(i).getDate()%>&pay_bus_location=<%=list.get(i).getPay_bus_location()%>&merchant_uid=<%=list.get(i).getMerchant_uid()%>'">
