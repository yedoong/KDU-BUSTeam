...
<head>
    ...
    <link rel="stylesheet" href="Student_Bus_Num4.css">
...
<body>
        	...
        	<header> <!-- s: header -->
         	...
         	<div id="nav"> <!--  nav -->
            	...
            	<div id="nav_btn">
                	...
                	<button id="Button3" name="bus_number" value="3호차">3호차</button>
                	<button id="Button4" name="bus_number" value="4호차">4호차</button>
            	</div>
       		</div>
    </form>
    <% 
    ...
    %>		
            <!-- 팝업 -->
            <form action="Student_Bus_Num4.jsp" method="post">
				<div id="bg"></div>
        			<div class="popup"> 
